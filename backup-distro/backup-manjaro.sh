...
# Backup filename + log file
BACKUP_FILE="$BACKUP_DIR/ps4manjaro_${DATESTAMP}.tar.xz"
LOG_FILE="$BACKUP_DIR/backup_manjaro_${DATESTAMP}.log"

# Run backup in background with logging
{
...
echo "[?] Manjaro backup started in background. Log: $LOG_FILE"
